    ...
    return SafeArea(
      child: Scaffold(
                              ...
                              Container(
                                child: StreamBuilder<QuerySnapshot>(
                                  stream: FirebaseFirestore.instance
                                    ...
                                    "id",
                                    arrayContains: uId,
                                  ).where("type" ,isEqualTo:"resident",).orderBy('time',descending: true).snapshots(),
                              ...
                              Container(
                                child: StreamBuilder<QuerySnapshot>(
                                  stream: FirebaseFirestore.instance
                                    ...
                                    "id",
                                    arrayContains: uId,
                                  ).where("type" ,isEqualTo:"staff",).orderBy('time',descending: true).snapshots(),
                                  builder: (BuildContext context,
                                      AsyncSnapshot<QuerySnapshot> snapshot) {
                                    print("user Id $uId");
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            selectedIndex == 0 ?
            Navigator.push(context,MaterialPageRoute(builder: (BuildContext context) => NewResidentChat()))
...
////////////////////////////////////////////////////////////////////////////
  ...
  Future<List<PeerUser>> userData(int tabViewIndex) async {
    ...
    if (tabViewIndex == 0) {
      usersCollection = FirebaseFirestore.instance.collection('userProfile').doc(peerId);
    ...
    if (documentSnapshot.exists) {
      PeerUser model = PeerUser(
        ...
        documentSnapshot.get('profileLink'),
      );
      print("========");
